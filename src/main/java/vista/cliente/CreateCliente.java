 ...
 * @author PC
 */
public class CreateCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ecuatoriano", "Colombiano", "Argentino ", "Venezolano", "Mexicano " }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Edad", "Ciudadania", "Direccion"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.clienteControlador.crear(args);
    ...
    private void actualizarTabla()
    {
        ...
        encabezado[0]="Nombre";
        encabezado[1]="Edad";
        encabezado[2]="Ciudadania";
        encabezado[3]="Direccion";
        
        var datos = new Object[this.clienteControlador.listar().size()][5];
        
        var i=0;
        for(var cliente:this.clienteControlador.listar())
        {
            datos[i][0]=cliente.getNombre();
            datos[i][1]=cliente.getYearNacimiento();
            datos[i][2]=cliente.getCiudadania();
